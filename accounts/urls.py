...
urlpatterns = [
    ...
    path('admin/support/<int:conversation_id>/delete/', admin_support_delete, name='admin_support_delete'),
    ...
    path('admin/feature-plans/<int:plan_id>/delete/', admin_feature_plan_delete, name='admin_feature_plan_delete'),
    path('admin/subscriptions/<int:subscription_id>/activate/', admin_subscription_activate, name='admin_subscription_activate'),
